  ...
  return (
    <View style={styles.container}>
        <View style={styles.encabezado}>
          <TouchableOpacity onPress={() => navigation.navigate('MenuPaciente')} style={styles.botonVolver}>
        ...
        <Text style={styles.subtitulo}>Pago procesado correctamente</Text>

        <TouchableOpacity style={styles.boton} onPress={() => navigation.navigate("MenuPaciente")}>
